...
const AttendanceHistory: React.FC<Props> = ({ user }) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "Tardanza":
        return "bg-jbOrange/10 text-jbOrange border-jbOrange/20 shadow-jbOrange/10";
      case "Falta":
        return "bg-jbRed/10 text-jbRed border-jbRed/20 shadow-jbRed/10";
      case "Presente":
      default:
        return "bg-jbTurquoise/10 text-jbTurquoise border-jbTurquoise/20 shadow-jbTurquoise/10";
    }
  };
                  ...
                  >
                      ...
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-4">
                          <img
                            ...
                            className="w-10 h-10 rounded-full bg-white border-2 border-slate-100 shadow-sm"
                            alt={r.userName}
                          />
                          <div>
                    ...
                    <td className="px-8 py-5">
                      {r.checkOut ? (
                        ...
                        <span className="text-jbOrange/50 italic text-[10px] font-black px-3 py-1 bg-jbOrange/5 rounded-full border border-jbOrange/10">
                          EN CURSO
                        </span>
                      )}
                    </td>
