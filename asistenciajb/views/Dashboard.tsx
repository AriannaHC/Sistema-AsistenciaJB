...
import { Users, Clock, TrendingUp, CheckCircle2, RefreshCw, UtensilsCrossed } from 'lucide-react';
    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          ...
          color="bg-jbTurquoise/10" textColor="text-jbTurquoise"
          subtitle="En Vivo"
        />
        ...
        <StatCard
          ...
          color="bg-jbOrange/10" textColor="text-jbOrange"
          subtitle="En Vivo"
        />
        <StatCard
          ...
          color="bg-jbBlue/10" textColor="text-jbBlue"
          subtitle="Histórico"
        />
        <StatCard
          ...
          color="bg-jbNavy/10" textColor="text-jbNavy"
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-xs text-jbGray font-semibold">Almorzando ahora</span>
                <span className="text-sm font-black text-jbOrange font-heading">{stats?.onLunchNow ?? 0}</span>
              </div>
            </div>
          </div>
        </div>
